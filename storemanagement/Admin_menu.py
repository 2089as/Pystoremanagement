...
class Admin:
    ...
    def export_to_excel(self):
        ...
        # Get the sales data from the treeview
        sales_data = [(self.tree.item(i)['values']) for i in self.tree.get_children('')]
        # Write the header row
        worksheet.append(["Transaction ID", "Invoice No.", "Product ID", "Description", "Quantity", "Total Price", "Date", "Time"])
        ...
        messagebox.showinfo("Export Successful", "Sales data has been exported to sales_data.xlsx")
